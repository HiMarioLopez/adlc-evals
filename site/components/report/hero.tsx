...
export function Hero({
  ...
  const inline = data.keyFindingsInline;
  ...
  return (
    <section className="relative flex items-center justify-center py-8 md:min-h-[calc(100vh-7rem)] md:py-12">
      ...
      <div
        className={`absolute right-1/4 bottom-1/4 h-[400px] w-[400px] animate-pulse rounded-full ${theme.blurOrb} blur-[120px]`}
      ...
      >
        ...
        <h1 className="mb-6 animate-fade-up font-bold text-5xl tracking-tight opacity-0 delay-100 sm:text-6xl md:text-7xl lg:text-8xl">
          ...
          <span className={theme.text}>{data.title.secondary}</span>
        </h1>
        ...
        <div className="mb-16 flex animate-fade-up flex-col items-center gap-3 opacity-0 delay-400">
          ...
          <div
            className={`flex items-center gap-4 rounded-2xl border border-border bg-card/80 px-6 py-4 backdrop-blur-sm transition-colors ${theme.hoverBorder}`}
          >
            <div
            ...
            <div className="text-left">
              ...
              <p className="font-semibold">{secondaryTheme.stackName}</p>
            </div>
          </div>
        </div>
